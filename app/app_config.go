...
import (
	_ "leochain/x/leochain/module"
	leochainmoduletypes "leochain/x/leochain/types"
	_ "leochain/x/token/module"
	tokenmoduletypes "leochain/x/token/types"
	"time"
		...
		Modules: []*appv1alpha1.ModuleConfig{
			{
				...
				Config: appconfig.WrapAny(&runtimev1alpha1.Module{
					...
					BeginBlockers: []string{
						...
						// chain modules
						leochainmoduletypes.ModuleName,
			...
			{
				Name:   leochainmoduletypes.ModuleName,
				Config: appconfig.WrapAny(&leochainmoduletypes.Module{}),
			},
			{
