...
import (
	...
	"leochain/docs"
	leochainmodulekeeper "leochain/x/leochain/keeper"
	tokenmodulekeeper "leochain/x/token/keeper"
)
...
type App struct {
	*runtime.App
	...
	LeochainKeeper leochainmodulekeeper.Keeper
